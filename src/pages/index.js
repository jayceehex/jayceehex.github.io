...
const IndexPage = ({ location }) => (
  <>
    ...
    <Layout location={location}>
      <BodyText>
        <p>
          <TextHighlight>Hello there!</TextHighlight> I'm a JavaScript developer
          from the West Country. I've got experience in React and Angular
          frameworks, and I'm trying to get better at functional programming.
          CSS styling is my favourite coding hobby, especially when it comes to
